...
being spun off from the work that will be published individually for reuse in other core environments or drivers.
...
experience easier but also provide more visilibity into the DXE Core's requirements and operating state in general.
